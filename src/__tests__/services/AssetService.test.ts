...
describe('AssetService', () => {
  ...
  describe('EventBus Integration', () => {
    ...
    test('should reconnect to EventBus if available', () => {
      // Arrange
      const mockDisconnectedRegistry = {
        getService: jest.fn().mockImplementation(() => { throw new Error('Service not found'); }),
        ...
        findService: jest.fn(),
        createProxy: jest.fn(),
        onServiceRegistered: jest.fn(),
        registerDependencies: jest.fn(),
