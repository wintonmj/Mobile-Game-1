...
export class MainScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    this.add
      .text(this.cameras.main.centerX, this.cameras.main.centerY - 50, 'Hello World!', {
        fontSize: '48px',
        color: '#ffffff',
        fontFamily: 'Arial',
      })
    ...
    this.countText = this.add
      .text(this.cameras.main.centerX, this.cameras.main.centerY, `Clicks: ${this.clickCount}`, {
        fontSize: '32px',
        color: '#00ff00',
        fontFamily: 'Arial',
      })
