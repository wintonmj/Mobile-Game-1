...
export class PlayerController {
    ...
    init() {
        ...
        this.keys = this.scene.input.keyboard.addKeys({
            ...
            cut: Phaser.Input.Keyboard.KeyCodes.ONE,
            mine: Phaser.Input.Keyboard.KeyCodes.TWO,
            fish: Phaser.Input.Keyboard.KeyCodes.THREE,
            water: Phaser.Input.Keyboard.KeyCodes.FOUR,
            pierce: Phaser.Input.Keyboard.KeyCodes.FIVE,
            carry: Phaser.Input.Keyboard.KeyCodes.C,
            hit: Phaser.Input.Keyboard.KeyCodes.H,
            death: Phaser.Input.Keyboard.KeyCodes.X
        });
    }
